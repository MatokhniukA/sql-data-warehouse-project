...
BEGIN
    ...
    BEGIN TRY
        ...
        -- LOAD & INSERT silver.crm_cust_info
    ...
    WHERE flag_last = 1;
        ...
        -- LOAD & INSERT silver.crm_prd_info
        SET @start_time = GETDATE();
    ...
    (SELECT DISTINCT id
        ...
        -- LOAD & INSERT silver.crm_sales_details
        SET @start_time = GETDATE();
    ...
    FROM silver.crm_cust_info
        ...
        -- LOAD & INSERT silver.erp_cust_az12
        SET @start_time = GETDATE();
    ...
    FROM bronze.erp_cust_az12;
        ...
        -- LOAD & INSERT silver.erp_loc_a101
        SET @start_time = GETDATE();
    ...
    FROM bronze.erp_loc_a101;
        ...
        -- LOAD & INSERT silver.erp_px_cat_g1v2
        SET @start_time = GETDATE();
    ...
    SELECT TRIM(id), -- Remove Unwanted Spaces
        TRIM(cat),
        TRIM(subcat),
        TRIM(REPLACE(maintenance, CHAR(13), '')) AS maintenance
    -- Handle a Hidden String Carry Symbol (newline character CHAR(13))
    FROM bronze.erp_px_cat_g1v2;

    -- Quality Check: Verify Data Loaded into silver.erp_px_cat_g1v2
    -- SELECT *
